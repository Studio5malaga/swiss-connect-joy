...
const days: any[] = [
  ...
  },
  {
    day: 3,
    date: "6 Oct (Martes)",
    route: "Kandersteg → Grindelwald → First → Blausee → Kandersteg",
    title: "Grindelwald First & Blausee",
    image: "/images/dia4-grindelwald-first.jpg",
    alt: "First Cliff Walk en Grindelwald, pasarela suspendida sobre los Alpes suizos",
    tags: ["Teleférico First", "Cliff Walk", "Blausee", "Sin maletas"],
    highlights:
      "Intercambio de última hora: el First se sube hoy, sin maletas y durmiendo de nuevo en Kandersteg. Teleférico al First con el Cliff Walk opcional por la mañana y broche de oro al atardecer en el lago azul del Blausee.",
    sections: [
      {
        title: "🚂 Mañana · Kandersteg → Grindelwald",
        content: [
          "09:14 · RE1 Kandersteg → Spiez 09:44",
          "10:06 · RE9 Spiez → Interlaken Ost 10:26",
          "11:04 · R61 Interlaken Ost → Grindelwald 11:40",
          "11:59 · Bus 120 → Firstbahn 12:02",
        ],
      },
      {
        title: "🏔️ Mediodía · Teleférico Grindelwald First",
        content: [
          "≈12:05-14:05 · Teleférico Grindelwald First (25 min por trayecto · 50% dto. con Swiss Travel Pass · ~36-38 CHF ≈ 41 €/persona · NO es gratis)",
          "Cima 12:30-13:40 · First Cliff Walk (pasarela del Eiger) opcional",
          "Descenso 13:40",
          "📍 Geocache GC1TKEP «First · Grindelwald» (tradicional, estación superior)",
        ],
      },
      {
        title: "🚂 Tarde · Regreso a Kandersteg",
        content: [
          "14:47 · R61 Grindelwald → Interlaken Ost 15:24 (sin maletas, nada que recoger)",
          "15:29 · RE9 Interlaken Ost → Spiez 15:48",
          "16:12 · RE1 Spiez → Kandersteg 16:40",
        ],
      },
      {
        title: "💎 Atardecer · El Blausee (Lago Azul) — Broche de Oro",
        content: [
          "16:58 · Bus 230 Kandersteg → Blausee 17:08 (GRATIS con Swiss Travel Pass)",
          "17:10-18:30 · Visita a Blausee con la última luz",
          "Sendero 100% llano y accesible hasta el lago · barca con fondo de cristal incluida en el acceso",
          "Tarifas orientativas: 11-13 CHF/adulto (~12-14 €) · grupo 66-84 € (reconfirmar en 2026)",
          "18:41 · Bus 230 de regreso → Kandersteg 18:54",
        ],
      },
    ],
    costs: [
      { concept: "Teleférico Grindelwald First (50% dto.)", pp: "~41 €", group: "~246 €" },
      { concept: "Entrada Blausee", pp: "~12-14 €", group: "~66-84 €" },
      { concept: "Trenes y buses del día", pp: "0 € (Swiss Pass)", group: "0 €" },
    ],
    tip: "💡 Plan B por lluvia: se mantiene el de Bern, sin cambios.",
    audioButtons: [AUDIO.suiza2026],
  },
  ...
  {
    day: 4,
    date: "7 Oct (Miércoles)",
    route: "Kandersteg → Interlaken → Brienz → Gengenbach",
    title: "Barco por el Lago de Brienz & traslado a la Selva Negra",
    image: "/images/dia3-sherlock-blausee.jpg",
    alt: "Lago de Brienz turquesa con cascadas, crucero BLS en Suiza",
    tags: ["Día de traslado", "Barco BLS", "Lago turquesa", "Villa Beckmann"],
    highlights:
      "Día de traslado con las 6 maletas, cambiando Kandersteg por Villa Beckmann en Gengenbach. De camino, crucero matinal por el lago turquesa de Brienz y pausa en Interlaken antes del salto a Alemania. Sin geocache confirmado en este tramo de barco.",
    sections: [
      {
        title: "🚂 Mañana · Kandersteg → Interlaken Ost",
        content: [
          "09:14 · RE1 Kandersteg → Spiez 09:44",
          "10:06 · RE9 Spiez → Interlaken Ost 10:26",
          "Ya NO hace falta consigna de equipaje en Interlaken: las maletas se quedan con el grupo todo el día",
          "Nota: si alguien prefiere guardarlas igualmente, hay consignas en Interlaken Ost (~7-10 €)",
        ],
      },
      {
        title: "⛴️ Mediodía · Barco BLS 63 hacia Brienz",
        content: [
          "11:07 · Barco BLS 63 Interlaken Ost → Brienz (Bönigen 11:25 · Ringgenberg 11:33 · Iseltwald 11:51)",
          "Barco de línea por el Lago de Brienz: GRATIS con Swiss Travel Pass",
          "12:20 · Llegada a Brienz · paseo lacustre y almuerzo hasta las 13:45",
          "Brienz es famoso por sus casas de madera tallada tradicionales",
        ],
      },
      {
        title: "🚄 Tarde · Regreso a Interlaken y pausa",
        content: [
          "14:02 · R70 Brienz → Interlaken Ost 14:24",
          "14:24-16:29 · Pausa en Interlaken: comer algo y pasear por el Höheweg",
        ],
      },
      {
        title: "🏡 Noche · Traslado a Gengenbach",
        content: [
          "16:29 · IC61 Interlaken Ost → Basel SBB 18:29",
          "18:46 · ICE 2 Basel SBB → Offenburg 19:56",
          "20:41 · RS1 Offenburg → Gengenbach 20:48",
          "Llegada a Villa Beckmann ≈21:00 · check-in autónomo (Keybox código 0816) · rellenar el Meldeschein",
        ],
      },
      {
        title: "🟡 Plan B · Si el barco no opera (viento/niebla)",
        content: [
          "Usar el R70 directo Interlaken Ost → Brienz 12:20 y volver igual",
        ],
      },
    ],
    costs: [
      { concept: "Barco BLS Lago de Brienz", pp: "0 € (Swiss Pass)", group: "0 €" },
    ...
    tip: "💡 Al ser día de traslado con maletas, prioriza conexiones con transbordos amplios (15-20 min) aunque se llegue algo más tarde. El barco es la joya del día: si el tiempo acompaña, no te lo pierdas.",
    audioButtons: [AUDIO.suiza2026],
  },
  {
    day: 5,
